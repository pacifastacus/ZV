...
\include{altalanos/altalanos_6}		%kész
\include{altalanos/altalanos_7}		%TODO
\include{altalanos/altalanos_8}		%kész
\include{altalanos/altalanos_9}		%kész
\include{altalanos/altalanos_10}	%Hiányzik az OPamp pozitív visszacsatolás
\include{altalanos/altalanos_11}	%kész
\cleardoublepage

%\part[Infokommunikációs hálózatok]{Infokommunikációs hálózatok specializáció}
\input{halozatok/halozatok_1}	%Nincs kidolgozott tétel
\include{halozatok/halozatok_2} %kész
